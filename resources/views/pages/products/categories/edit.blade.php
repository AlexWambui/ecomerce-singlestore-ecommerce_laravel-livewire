<x-app-layout>
    <div class="custom_form py-4 max-w-4xl mx-auto">
        ...
        <form action="{{ route('product-categories.update', $product_category->uuid) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="inputs">
                ...
                <textarea name="description" id="ckeditor" cols="30" rows="10">{{ old('description', $product_category->description) }}</textarea>
